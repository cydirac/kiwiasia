        <div class="row" style="margin-bottom:30px;background: rgba(00, 00, 00, .8)">
                <div class="col-md-8">
                <iframe width="100%" height="auto" src="https://www.youtube.com/embed/z3W595WQw4E?ecver=1" frameborder="0" allowfullscreen></iframe>                
                </div>
                <div class="col-md-4">
